...
and publishing reserach data? Through technical benchmarking and user tests
we have concluded that existing solutions can be used to share and publish research
data. The user experience of the tools could be enhanced to make research data
sharing and publishing easier, but the problems with the tools do not prevent
sharing and publishing of reserach data. The lack of tools to manage research data
...
barrier to publishing and sharing research data. In order to make the tools
...
starts from proving the benefits of sharing and publishing research data,
generating proper incentives for the users and by providing education for the
users.
