...
Here is a look to the releavant papers and such - I will update this section once
...
and redistribution \cite{suber2007open, bailey2008open}. Research papers
...
(ranging between 36\% - 172\% increase \cite{DBLP:journals/corr/abs-cs-0606079, harnad2004comparing, eysenbach2006citation}). Open access publishing of research papers make the
...
are required to publish their reserach papers
\footnote{\url{http://roarmap.eprints.org/}}. The mandate likely has
...
public data repository about the growth of open access
\footnote{\url{http://dataverse.scholarsportal.info/dvn/dv/dgoa}}.
...
\cite{DBLP:journals/scientometrics/Hirsch10}, don't exist either for reserch
...
Peer reviewing, which is in the heart of making sure that research papers
and thus research is valid, is yet to be introduced to the process of
publishing research data. One study piloted a process of reviewing datasets
the reserchers had used \cite{DBLP:journals/ijdc/GrootveldE12}. The study found
...
sophisticated and rigorious statistical analysis to prove the causatoin would
be required.

Another study notes that open access research papers get more downloads and
readers, but no more citations. The citation advantage might be an artefact
