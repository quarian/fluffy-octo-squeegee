...
are required to publish their research papers
...
\cite{DBLP:journals/scientometrics/Hirsch10}, don't exist either for research
...
Metadata refers to data about data. It's a description of the data and entails
...
The comparison of amounts of errors is shown in \ref{fig:errors}. In order
