...
\section{Research on open access publishing}
...
\cite{suber2007open, bailey2008open}.
The research on open access publishing shows that publishing research papers openly correlates to
increased citations to the research papers (ranging between 36\% - 172\% increase
...
to be more available than research papers that are not openly accessible. Open access
has also introduced the concept of an open access mandate, which is a mandate or
...
amount of open access journals world wide at 10 703 at the time of writing this
...
the practices of research data open access publishing are far from those of research paper open access
publishing. Metrics, such as the h-index
\cite{DBLP:journals/scientometrics/Hirsch10}, do not exist for research
data nor is research data publishing accounted for in the h-index.
...
The latest reserch shows that the acceptance towards sharing research data is
growing. Challenges, like the quality of tools for research data sharing and
management and the lack of training for research data management still exist
but it seems that the world of reserarch is moving towards sharing research
data. \cite{10.1371/journal.pone.0134826}
...
culture surrounding research data management, publication and sharing.
The challenges are presented in more detail below
...
metadata standards for their research data and that research data comes in many different
...
working in to enable collaboration while preventing access from the rest of
the world \cite{DBLP:journals/libt/Witt08}.
...
listed below \cite{DBLP:journals/lht/SiLZXHLX15}:
...
\begin{figure}
    \begin{centering}
        \includegraphics[width=\textwidth]{images/beneficaries2}
    \end{centering}
    \caption{The different beneficiaries and rationales of data sharing - figure drawn after \cite{DBLP:journals/jasis/Borgman12}}
...
\begin{figure}
    ...
    \end{centering}
    \caption{The difference in reporting errors between research papers with not
    public and public research data from the field of psychology \cite{wicherts2011willingness}}
    \label{fig:errors}
\end{figure}
...
indirectly~\cite{piwowar2007sharing}.

In a study about cancer microarray clinical publications it was found out that
research papers that had their research data published received a 69\%
...
the investment to a research data repository gives a generous return of investment to
the institution building and using the repository. The study makes a
...
in an open access way and an increased citation rate, there are studies that take this claim critically and
examine whether there are other causes that would explain the perceived
citation advantage. In one study
\cite{DBLP:journals/joi/CraigPMPA07} the research methods of studies that show
the increased citation rates with open access publishing do not take all the
...
publishing should be carefully designed. There are studies refuting the
...
organizations. The general ways to publish research data openly are the following:
...
The reasons behind not sharing research data were different. In the smallest study~\cite{savage2009empirical},
where the researchers were able to contact the people who refused to share, the reasons
...
\section{Implementations in the literature}
...
research papers. You can read the background of Dataverse from \cite{king2007introduction}.
...
Invenio is a CERN born open source reseach data repository. It began as a CERN
documentation server, aiming to be a publishing platform for the so called
''grey literature'' - research output produced outside commercial and academic
distribution channels - which has been a CERN way of publishing. It has since
grown and been adapted worldwide as a backbone of many repository solutions.
\cite{Caffaro:1312678}

The implementations mentioned here have been open source solutions. Elsevier,
an academic publishing company, has also integrated research data management
tools to their publication management solutions. Currently their solution
is known as Pure and it integrates to other Elsevier solutions.
\cite{DBLP:conf/eurocris/ClementsM14}
