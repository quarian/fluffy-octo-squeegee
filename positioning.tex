...
Master's theses do not live in a vacuum. To position the thesis and provide the
...
from universities' systems automatically would be useful.\footnote{M. Nurmela
...
manage it in a sufficient way. The skillset that is required for data handling
...
Separately from this thesis two studies were conducted in Aalto University about research data management
and sharing by Ilari Lähteenmäki and Aalto IT services \cite{survey1, survey2}. The goal of the studies was to find out the current needs as well
...
\begin{figure}[h]
    ...
    \end{centering}
    \caption{The respondents to the first questionnaire, divided by the school of the respondents \cite{survey1}}
...
\begin{figure}[b]
    \begin{centering}
        \includegraphics[width=0.7\textwidth]{images/challenges2}
    \end{centering}
    \caption{Where the biggest challenges lie with research data management, divided by the phase of research process \cite{survey1}}
...
\begin{figure}[h]
    ...
    \end{centering}
    \caption{The affiliations of the respondents to the second questionnaire \cite{survey2}}
    \label{fig:answers_branches}
\end{figure}

The second questionnaire found that the most important things for research data
management and sharing system would be that the research data
...
\begin{figure}[h]
    ...
    \end{centering}
    \caption{The different parties research data has to be shared with - horizontal axis is the amount of respondents \cite{survey2}}
...
\begin{figure}[h]
    ...
    \caption{The required storage capacities according to the respondents - vertical
             axis is the percentage of respondents \cite{survey2}}
    \label{fig:size}
\end{figure}
...
during the project it is being created.
...
research data during the research project. EUDAT project source code for
...
institutions. It is is likely that other institutions and the institutions listed
