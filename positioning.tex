...
shows who the daat needs to ba shared with. The research data should be
...
\begin{figure}
    ...
    \end{centering}
    \caption{The required storage capacities according to the respondents}
    \label{fig:size}
\end{figure}
...
\begin{figure}
    ...
    \end{centering}
    \caption{The required storage time of datasets}
    \label{fig:time}
\end{figure}
...
management through the lifecycle of data. Existing cloud based solutions, such
...
service called B2Drop\footnote{\url{https://eudat.eu/services/b2drop}}, which is targeted to researches that want to share
reseach data during the research project.
