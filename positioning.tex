...
\begin{table}[h]
    \centering
    \caption{Finnish actors and what they are working on}:
    \label{table:finland}
    \begin{tabularx}{\textwidth}{| >{\raggedright}p{3cm} | X |}
      ...
      \hline
      \rowcolor{Gray}
      University of Helsinki                    & University of Helsinki has formulated its data policy\footnotemark and is working
                                                  towards implementing the infrastructure required to support it.\footnotemark\\
      \hline
      No Place to Put Data                      & 264 \\
      \hline
      \rowcolor{Gray}
      Lack of Standards                         & 222 \\
      \hline
      Sponsor does not Require                  & 196 \\
      \hline
      \rowcolor{Gray}
      Do not Need Data                          & 169 \\
      \hline
      Other Reasons For Data Not Available      & 164 \\
      \hline
      \rowcolor{Gray}
      Should not be Available                   & 162 \\
      \hline
    \end{tabularx}
\end{table}
