...
the system. The research also shows that a succesful repository system requires
user engagement \cite{DBLP:conf/ercimdl/Martinez-UribeM09}. Scientist and
researcher interviews were concudcted within different researcher groups and
...
findings from literature. Data management is not taught for the researchers and
there is no culture or experience in sharing data. Upon questioning it became
clear that the data in the posession of the researchers would have required
a lof of cleaning and metadata additions prior to publishing - no surprise
...
publishing infrastructure were also brough up.
...
data, since using the existing solutions to share hundreds of gigabytes would
prove cumbersome.

One member of the group had taken a role of a mentor wit the data management
...
researcher expressed interest in sharing and using others' datastests, but
...
to be maintained and run by people other than the reserachers, since the job of
the researchers is to do research and not maintain sofware systems. With this
in mind the people managin the scientific IT systems are a key component to
building a succesful research data management, publication and sharing
platform.
...
building scientific computing environments for Finnish instituitons (research,
...
insitutions and working together would enable that.
...
first in Finland to implement a data plicy in practice, offering an
...
and modify to accept Jyväskylä credentials, it still had a long way to go
before it was universally accepted within the university. At the time of
writing this, the Jyväskylä Dataverse has been runnign for appriximately a
year and it contains a grand total of seven files. Some research groups,
...
developed a system to facilitate collaboration between reserachers
...
were planning to start testing the fedration capabilites. Following up on that
...
primary users disucssed in Sections \ref{sec:expert_interviews} and
...
international or discipline specific repositories could use those as well.
\footnote{M. Nurmela, A. Sunikka, personal communication, July 17th, 2015}
...
plan tool\footnote{\url{http://portti.avointiede.fi/tutkimusdata/tuuli-tyokalu-tutkimuksen-datanhallinnan-suunnitteluun}} and managing the Finnish unique identifier
...
archiving, managing and reuse is impossible. Making metadata work within an
insitution requires commitment from all levels of management and tools to
facilitate that. It's also important to note that even if two systems within
different organizations would be technologically perfeclty compatible,
the bottlenecks might stem from different policies in different organizations
and the bureucracy that comes with it. This thought lessens the burden for all
technology to be perfeclty compatible. \footnote{M. Nurmela and E. Keskitalo, personal communication, August 21st, 2015}
